...
<div >
    ...
    <div class="" v-for="(item, index) in about" class="list-group" v-show="(pag - 1) * num_results <= index  && pag * num_results > index">
...
<div class="d-flex bd-highlight mb-3">
  <div class="ms-auto bd-highlight">
    ...
    <button class="btn btn-outline-dark btn-sm" href="#" aria-label="Next" v-show="pag * num_results / about.length < 1" @click.prevent="pag += 1">
