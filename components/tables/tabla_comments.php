...
<div >
    <div class="d-flex bd-highlight">
        ...
        <div class="p-2 flex-shrink-1 bd-highlight">
            <button class="btn btn-dark" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRegistrComentarios" aria-controls="offcanvasRight"><i class="fa-duotone fa-plus"></i></button>
        </div>
    </div>
    <div class="" v-for="(item, index) in comments" class="list-group" v-show="(pag - 1) * num_results <= index  && pag * num_results > index">
            ...
            <div class="d-flex align-items-center ms-auto mt-2">
                ...
                <div class="flex-shrink-0">
                    <div>
                        ...
                        <button class="btn btn-sm" @click="EliminarComments(item.id_comentario)">
...
<div class="d-flex bd-highlight mb-3">
  <div class="ms-auto bd-highlight">
    ...
    <button class="btn btn-outline-dark btn-sm" href="#" aria-label="Next" v-show="pag * num_results / comments.length < 1" @click.prevent="pag += 1">
